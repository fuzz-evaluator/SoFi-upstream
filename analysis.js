...
var seedname = args[0];
var varintrolog = args[1];
var livevarlog = args[2];
var statictypelog = args[3];       //"statictypelog";
var funargtypelog = args[4];
var whether_gen_expression = args[5]; // true;
...
function getLiveReflectAst(locmd5){
    var reflectcode = "";
    ...
    visit(liveast, {
        visitExpressionStatement(path){
            ...
            if(nodeExpression!=null && nodeExpression!=undefined && nodeExpression.left!=null && nodeExpression.left!=undefined){
                var reflectast = getLiveReflectAst(locmd5);
                utils.insertnodeafter(path, reflectast);
            }
            utils.visitnode(this, path);
        },
